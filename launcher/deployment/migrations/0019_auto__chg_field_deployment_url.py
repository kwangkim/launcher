...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deployment.url'
        db.alter_column(u'deployment_deployment', 'url', self.gf('django.db.models.fields.CharField')(max_length=600))

    def backwards(self, orm):

        # Changing field 'Deployment.url'
        db.alter_column(u'deployment_deployment', 'url', self.gf('django.db.models.fields.CharField')(max_length=200))
