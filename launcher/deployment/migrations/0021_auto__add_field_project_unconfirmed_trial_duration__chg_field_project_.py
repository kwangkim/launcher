...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.unconfirmed_trial_duration'
        db.add_column(u'deployment_project', 'unconfirmed_trial_duration',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Project.trial_duration'
        db.alter_column(u'deployment_project', 'trial_duration', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Project.unconfirmed_trial_duration'
        db.delete_column(u'deployment_project', 'unconfirmed_trial_duration')


        # Changing field 'Project.trial_duration'
        db.alter_column(u'deployment_project', 'trial_duration', self.gf('django.db.models.fields.IntegerField')())
