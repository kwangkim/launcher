...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'deployment_deployment', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='deployments', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deployment.user'
        db.delete_column(u'deployment_deployment', 'user_id')
