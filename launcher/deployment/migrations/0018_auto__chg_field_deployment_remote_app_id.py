...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deployment.remote_app_id'
        db.alter_column(u'deployment_deployment', 'remote_app_id', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Deployment.remote_app_id'
        db.alter_column(u'deployment_deployment', 'remote_app_id', self.gf('django.db.models.fields.IntegerField')())
