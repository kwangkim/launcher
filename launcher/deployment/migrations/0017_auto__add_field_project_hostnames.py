...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.hostnames'
        db.add_column(u'deployment_project', 'hostnames',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.hostnames'
        db.delete_column(u'deployment_project', 'hostnames')
